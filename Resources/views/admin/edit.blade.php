@extends('Core.Admin.Http.Views.layout', [
    'title' => __('admin.title', ['name' => __('banscomms.admin.edit_title')]),
])
...
@push('content')
    <div class="admin-header d-flex align-items-center">
        ...
        <div>
            <h2>@t('banscomms.admin.edit_title')</h2>
            <p>@t('banscomms.admin.edit_description')</p>
        </div>
    </div>

    <form data-form="edit" data-page="banscomms" enctype="multipart/form-data">
        @csrf
